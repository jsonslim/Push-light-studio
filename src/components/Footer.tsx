    ...
    return (
        <footer className="footer">
            <div className="footer-content">
                <span className="footer-text">Support this project:</span>
                <div className="footer-links">
                    ...
                    >
                        <svg viewBox="0 0 24 24" className="footer-icon">
                            <path fill="currentColor" d="M17.813 0c-2.746 0-5.147 1.39-6.563 3.512C9.835 1.39 7.434 0 4.688 0 2.099 0 0 2.099 0 4.688c0 5.023 6.406 10.305 11.25 13.547 4.844-3.242 11.25-8.524 11.25-13.547C22.5 2.099 20.401 0 17.813 0zm-6.563 15.938c-3.633-2.461-8.672-6.797-8.672-11.25 0-1.653 1.348-3 3-3 1.653 0 3 1.347 3 3v3.75h5.344v-3.75c0-1.653 1.348-3 3-3 1.653 0 3 1.347 3 3 0 4.453-5.039 8.789-8.672 11.25z" />
                        </svg>
                        Boosty
                    </a>
                </div>
